...
import { RiShieldUserLine } from "react-icons/ri";  // ← NEW icon for admin
      ...
      <nav className="navbar-root">
        <div className="flex justify-between items-center px-6 h-14">
          ...
          <div className="nav-desktop-btns flex items-center gap-2">
            ...
            {/* ← NEW — Admin button only for admin role */}
            {user && user.role === "admin" && (
              <Link to="/admin">
                <button className={`nav-btn-admin ${location.pathname === "/admin" ? "nav-btn-admin-active" : ""}`}>
        ...
        {menuOpen && (
          <div className="mobile-menu">
            ...
            {/* ← NEW — Admin button in mobile menu */}
            {user && user.role === "admin" && (
              <Link to="/admin" onClick={() => setMenuOpen(false)}>
                <button className="nav-btn-admin" style={{ width: "100%", justifyContent: "center" }}>
